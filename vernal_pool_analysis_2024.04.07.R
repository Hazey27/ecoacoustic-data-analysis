...
file_names <- list.files(path = "~/Lake_george_sound_analysis/vernal_pool_wav", 
                         pattern = "*.sud", all.files = FALSE, full.names = FALSE, recursive = FALSE, ignore.case = FALSE, 
                         include.dirs = FALSE, no.. = FALSE)

#Sets working directory to vernal pool data
setwd("~/Lake_george_sound_analysis/vernal_pool_wav")
...
# Read each .wav file and store ```
Wave objects in a list
